...
function getCourseData(CourseData){
  ...
  CourseData.Semesters.forEach(courseObject => { 
    tableList.push(<SemesterCourses key = {key} Name={courseObject.Name} GPA={courseObject.GPA} 
      C1 = {courseObject.C1 && {CourseID: courseObject.C1.CourseID, Instructor: courseObject.C1.Instructor, Grade: courseObject.C1.Grade, CourseName: courseObject.C1.CourseName}}
      C2 = {courseObject.C2 && {CourseID: courseObject.C2.CourseID, Instructor: courseObject.C2.Instructor, Grade: courseObject.C2.Grade, CourseName: courseObject.C2.CourseName}}
      C3 = {courseObject.C3 && {CourseID: courseObject.C3.CourseID, Instructor: courseObject.C3.Instructor, Grade: courseObject.C3.Grade, CourseName: courseObject.C3.CourseName}}
      C4 = {courseObject.C4 && {CourseID: courseObject.C4.CourseID, Instructor: courseObject.C4.Instructor, Grade: courseObject.C4.Grade, CourseName: courseObject.C4.CourseName}}
      />);
      key += 1;
  });
